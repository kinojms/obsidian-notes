...
Think of the library as the middleman that can recognize certain commands or function calls, then it calls their supplier, tells them a code call in the OS, 
